        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbarcollapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="outlet"><i class="glyphicon glyphicon-tower"></i>Outlet</a>
                    </li>
                    <li>
                        <a href="paket"><i class="glyphicon glyphicon-folder-close"></i>Paket</a>
                    </li>
                    <li>
                        <a href="pelanggan"><i class="glyphicon glyphicon-sunglasses"></i>Pelanggan</a>
                    </li>
                    <li>
